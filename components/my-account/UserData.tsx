...
function UserDataEdit({ title, data }: Props) {
  return (
    <div data-user-edit-form class="hidden">
      <Title content={title} size="medium" />
      <div>
        ...
        <div class="form-control w-full max-w-xs">
          <label class="label">
            <span class="label-text uppercase font-bold">
              Nome que deseja ser chamado(a)
            </span>
          </label>
          <input
            type="text"
            placeholder="Nome que deseja ser chamado(a)"
            value={`${data.friendlyName ? data.friendlyName : ""}`}
            class="input input-bordered w-full max-w-xs"
          />
        </div>
      </div>
      ...
      <div class="form-control w-full max-w-xs">
        ...
        <select class="select select-bordered w-full max-w-xs">
          <option value="Masculino" selected={data.gender === "Masculino"}>
            Masculino
          </option>
          <option value="Feminino" selected={data.gender === "Feminino"}>
            Feminino
          </option>
          <option value="Outro" selected={data.gender === "Outro"}>
            Outro
          </option>
        </select>
      </div>
